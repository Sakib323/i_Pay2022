...
public class buying extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        UnityAds.initialize(buying.this,GameID, Testmode, new IUnityAdsInitializationListener() {
            @Override
        ...
        confirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String val = amountofdaimond.getEditText().getText().toString();
                if(val.isEmpty()){
                    AlertDialog.Builder alert= new AlertDialog.Builder(buying.this);
                    LayoutInflater inflater = (buying.this).getLayoutInflater();
                    alert.setMessage("Please Place an amount you want to buy.");
                    ...
                    if(cost>balance){
                        AlertDialog.Builder alert= new AlertDialog.Builder(buying.this);
                        LayoutInflater inflater = (buying.this).getLayoutInflater();
                        alert.setMessage("You don't have this much iCoin in your account");
                        alert.setCancelable(false);
                        alert.setView(inflater.inflate(R.layout.diamondbox,null));
                        alert.setPositiveButton("Okay", new DialogInterface.OnClickListener() {
                            @Override
                        ...
                        int total=youhave+item;
                        SharedPreferences share=getSharedPreferences("amountofdiamond",MODE_PRIVATE);
                        SharedPreferences.Editor editor=share.edit();
                        editor.putInt("diamond",total);
                        editor.apply();


                        AlertDialog.Builder alert= new AlertDialog.Builder(buying.this);
                        LayoutInflater inflater = (buying.this).getLayoutInflater();
                        alert.setMessage("You have bought "+item);
                        alert.setCancelable(false);
    ...
    private void unity(){
        IUnityAdsShowListener iUnityAdsShowListener=new IUnityAdsShowListener() {
            ...
            public void onUnityAdsShowFailure(String s, UnityAds.UnityAdsShowError unityAdsShowError, String s1) {
                UnityAds.load(AppID);
                UnityAds.show(buying.this,AppID);
            }
